...
export default function PrintPlanOwnership({ plan, onRowsChange, visibleKeys, shoppingDisabled = false, compact = false }) {
  ...
  return <section aria-label="Ownership for this print list">
    {!compact && <p>This checks only the copies in this reviewed {plan.mode === 'adhoc' ? 'print list' : plan.source
    ...
    <ManaSyncOwnership cards={cards} showConfirmations={false} initiallyOpen={!compact} onRowsChange={onRowsChange} visibleKeys={visibleKeys} shoppingDisabled={shoppingDisabled} compact={compact} />
  </section>;
}
